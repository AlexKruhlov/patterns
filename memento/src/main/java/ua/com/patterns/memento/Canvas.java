...
import ua.com.patterns.memento.commands.ColorCommand;
import ua.com.patterns.memento.commands.MoveCommand;
import ua.com.patterns.memento.shapes.Shape;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                ua.com.patterns.memento.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
